...
Currently working on a project focused on the management, analysis andprocessing of military data through a multi-tier architecture. Focusing on both backend and frontend sides, I developed part of the application’s interface and domain logic layer. During this project I intensely worked with technologies like OracleDB, Spring framework, Apache Maven, GeoServer and the Vaadin framework. 
}

...
\section{Summary}
I achieved my master's degree in computer engineering in 2015, working on a project involving heavy use of non-relational databases for fast and deep searches. In my current works I'm further specializing my NRDBMS knowledge, OO languages and web services.
\newline{}
I'm a curious person that likes to always take new challenges and open to learn new things. I like to put a lot of attention to details and never take compromises, if possible.
...
Currently working in the company's defense department, I'm developing an application responsible of the tracking and management of military threats and the definition of appropriate countermeasures. Focusing on both backend and frontend sides, I developed part of the application’s interface and domain logic layer, using frameworks like Vaadin and Spring MVC.
}

\cventry{Sep 2014}{Software Engineer}{\textsc{Translated}}{Rome}{}{
Working in Translated, I was tasked on the switch from a classic relational database to a NoSQL, graph database, working with technologies like OrientDB and Neo4j. In this work I developed methods of smart imports of large, unorganized data; conceptualized a graph structure for highly customizable searches; developed both APIs and service layer in order to integrate the database to the existing infrastructure; developed a message queuing service for keeping both relational and graph database’s data synchronized. All of this work was to help improve the quality of Translated's main product: MateCAT. The most used languages were Java and PHP.}

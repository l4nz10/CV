...
\section{Summary}
Software developer with a master degree in Computer Engineering. Strong knowledge of the Java programming language, good knowledge of JavaScript, C++ and also basic experience Python and PHP. My working experience comprises an in-depth use of both non-relational and relational DBMS with a full coverage of the back-end environment and sizable work on the front-end side.
\newline{}
...
\cvitem{OS}{Windows, Linux, OS X}
\cvitem{Languages}{Java, Javascript, C++, PHP, Python}
